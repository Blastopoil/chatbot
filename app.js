...
(function () {
  ...
  const SUGGESTION_POOLS = {
    about: [
      "Tell me about Felix.",
      "Summarize Felix's background.",
      "What is Felix's background?",
      "Give me a quick bio of Felix.",
      "Where did Felix study and work?",
      "What motivates Felix’s work?",
      "Tell me about Felix, in a Haiku",
    ],
    expertise: [
      "What is Felix's expertise in?",
      "What projects are Felix working on?",
      "What topics does Felix focus on?",
      "Which areas does Felix research?",
      "What’s Felix’s experience with gem5?",
      "What languages and tools does Felix use?",
      "What problems is Felix currently exploring?",
    ],
    contact: [
      "How do I contact Felix?",
      "What's the best way to reach Felix?",
      "Where can I find Felix online?",
      "Share Felix’s email and social links.",
      "Where is Felix located?",
    ],
    site: [
